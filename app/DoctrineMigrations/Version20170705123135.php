 ...
 */
class Version20170705123135 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE affaires (id_affaire INT AUTO_INCREMENT NOT NULL, id_organisme INT NOT NULL, year SMALLINT NOT NULL, numero_affaire INT NOT NULL, nom_affaire VARCHAR(100) NOT NULL, date_butoir DATE DEFAULT NULL, travail_a_effectuer VARCHAR(300) NOT NULL, INDEX id_organisme_fk_affaires (id_organisme), PRIMARY KEY(id_affaire)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE documents (id_document INT AUTO_INCREMENT NOT NULL, id_affaire INT NOT NULL, type VARCHAR(10) DEFAULT NULL, filename VARCHAR(150) NOT NULL, date_reception DATE NOT NULL, date_limite_visa DATE NOT NULL, etat TINYINT(1) NOT NULL, path VARCHAR(2083) NOT NULL, INDEX documents_affaires_fk (id_affaire), PRIMARY KEY(id_document)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE items (id_item INT AUTO_INCREMENT NOT NULL, id_lot INT NOT NULL, type VARCHAR(10) NOT NULL, nom_item VARCHAR(50) NOT NULL, tag VARCHAR(25) NOT NULL, INDEX lots_item_fk (id_lot), PRIMARY KEY(id_item)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lots (id_lot INT AUTO_INCREMENT NOT NULL, id_affaire INT NOT NULL, id_nom_lot SMALLINT DEFAULT NULL, numero_lot SMALLINT NOT NULL, INDEX noms_lots_lots_fk (id_nom_lot), INDEX affaires_lots_fk (id_affaire), PRIMARY KEY(id_lot)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE remarques_visa (id_remarque_visa INT AUTO_INCREMENT NOT NULL, id_visa INT NOT NULL, id_type_remarque SMALLINT DEFAULT NULL, no_remarque SMALLINT NOT NULL, remarque VARCHAR(300) NOT NULL, INDEX IDX_C69B6E989D91B70A (id_visa), INDEX IDX_C69B6E98CAA3EC32 (id_type_remarque), PRIMARY KEY(id_remarque_visa)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id_utilisateur INT AUTO_INCREMENT NOT NULL, id_organisme INT DEFAULT NULL, mail VARCHAR(100) NOT NULL, password VARCHAR(255) NOT NULL, statut VARCHAR(10) NOT NULL, nom VARCHAR(30) NOT NULL, prenom VARCHAR(30) NOT NULL, tel VARCHAR(20) DEFAULT NULL, UNIQUE INDEX UNIQ_1D1C63B35126AC48 (mail), INDEX id_organisme_fk_utilisateur (id_organisme), PRIMARY KEY(id_utilisateur)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE visas (id_visa INT AUTO_INCREMENT NOT NULL, id_item INT NOT NULL, id_document INT DEFAULT NULL, vise_par INT NOT NULL, version SMALLINT NOT NULL, date_emission DATE NOT NULL, etat_visa VARCHAR(9) NOT NULL, indice_plan VARCHAR(4) NOT NULL, INDEX IDX_15C3F692943B391C (id_item), INDEX IDX_15C3F69288B266E3 (id_document), INDEX IDX_15C3F692C825F448 (vise_par), PRIMARY KEY(id_visa)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE remarques_visa ADD CONSTRAINT FK_C69B6E989D91B70A FOREIGN KEY (id_visa) REFERENCES visas (id_visa)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE remarques_visa DROP FOREIGN KEY FK_C69B6E989D91B70A');
