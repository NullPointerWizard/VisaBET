 ...
 */
class Version20170628122819 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE documents (id_document INT AUTO_INCREMENT NOT NULL, id_affaire INT DEFAULT NULL, type VARCHAR(10) DEFAULT NULL, filename VARCHAR(150) NOT NULL, date_reception DATE NOT NULL, date_limite_visa DATE NOT NULL, etat TINYINT(1) NOT NULL, path VARCHAR(2083) NOT NULL, INDEX documents_affaires_fk (id_affaire), PRIMARY KEY(id_document)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE items (id_item INT AUTO_INCREMENT NOT NULL, id_lot INT DEFAULT NULL, type VARCHAR(10) NOT NULL, nom_item VARCHAR(50) NOT NULL, tag VARCHAR(25) NOT NULL, INDEX lots_item_fk (id_lot), PRIMARY KEY(id_item)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE remarques_visa (id_remarque_visa INT AUTO_INCREMENT NOT NULL, id_visa INT DEFAULT NULL, id_type_remarque SMALLINT DEFAULT NULL, no_remarque SMALLINT NOT NULL, remarque VARCHAR(300) NOT NULL, INDEX IDX_C69B6E989D91B70A (id_visa), INDEX IDX_C69B6E98CAA3EC32 (id_type_remarque), PRIMARY KEY(id_remarque_visa)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
